...
RULE_BASED_THRESHOLDS: dict[str, float] = {
    ...
    "min_depth_drop": 0.03,  # relative hip drop needed to count as reaching bottom.
    "ascent_trigger": 0.15,  # relative hip position to start counting ascent.
    "top_tolerance": 0.08,  # how close to baseline to finish a rep.
    "knee_to_ankle_ratio_min": 0.8,  # ratio of knee width to ankle width to avoid caving.
    "torso_forward_max_deg": 30.0,  # max torso lean angle before flagging rounding/lean.
