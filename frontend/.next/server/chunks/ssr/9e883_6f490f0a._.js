...
"[project]/frontend/node_modules/@mediapipe/tasks-vision/vision_bundle.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const m = t.navigator;
function y(t) {
    return !!h && !!p && p.brands.some(({ brand: e })=>e && -1 != e.indexOf(t));
}
function _(e) {
    var n;
...
function Ue(t) {
    ...
    if ((e = t.length) && !(512 & n)) {
        var r = t[e - 1], i = !1;
        lt(r) ? (e--, i = !0) : r = void 0;
        var s = e - (n = 512 & n ? 0 : -1), o = (Le ?? me)(s, n, t, r);
...
function Be(t, e, n = ot) {
    if (null != t) {
        ...
        if (Array.isArray(t)) {
            var r = 0 | t[Q];
            return 2 & r ? t : (e &&= 0 === r || !!(32 & r) && !(64 & r || !(16 & r)), e ? (rt(t, 34 | r), 4 & r && Object.freeze(t), t) : Pe(t, Be, 4 & r ? ot : n, !0, !0));
        }
...
function qn(t) {
    return t ? /^\d+$/.test(t) ? (Vt(t), new Jn(Mt, Pt)) : null : Zn ||= new Jn(0, 0);
}
...
let Zn;
function Qn(t) {
    return t ? /^-?\d+$/.test(t) ? (Vt(t), new tr(Mt, Pt)) : null : er ||= new tr(0, 0);
}
var tr = class {
    constructor(t, e){
        this.h = t >>> 0, this.g = e >>> 0;
...
function Pr(t, e, n, r) {
    ...
    var s = r[1];
    let o = 1;
    s && s.constructor === Object && (i.ga = s, "function" == typeof (s = r[++o]) && (i.la = !0, Ir ??= s, Mr ??= r[o + 1], s = r[o += 2]));
    const a = {};
...
function Dr(t, e, n, r, i) {
    const s = n.g;
    let o, a;
    t[e] = (t, e, n)=>s(t, e, n, a ||= Pr(Lr, Ur, Dr, r).T, o ||= Nr(r), i);
}
function Nr(t) {
    let e = t[Rr];
    if (null != e) return e;
...
var ni = Wr(function(t, e, n) {
    ...
    null != (e = qt(e)) && (ar(t, n, 1), t = t.g, (n = It ||= new DataView(new ArrayBuffer(8))).setFloat64(0, +e, !0), Mt = n.getUint32(0, !0), Pt = n.getUint32(4, !0), sr(t, Mt), sr(t, Pt));
...
function xo(t) {
    ...
    if ((e = hn(t, cs, 4)?.h()) && (s.boundingBox = {
        originX: _n(e, 1) ?? 0,
        originY: _n(e, 2) ?? 0,
        width: _n(e, 3) ?? 0,
        height: _n(e, 4) ?? 0,
        angle: 0
    }), hn(t, cs, 4)?.g().length) for (const e of hn(t, cs, 4).g())s.keypoints.push({
        x: ze(e, 1) ?? 0,
        y: ze(e, 2) ?? 0,
        score: ze(e, 4) ?? 0,
        label: vn(e, 3) ?? ""
...
var Zo = class {
    ...
    l(t, e = !0) {
        if (e) {
            ...
            if (!(hn(this.baseOptions, Fs, 1)?.g() || hn(this.baseOptions, Fs, 1)?.h() || t.baseOptions?.modelAssetBuffer || t.baseOptions?.modelAssetPath)) throw Error("Either baseOptions.modelAssetPath or baseOptions.modelAssetBuffer must be set");
            if (function(t, e) {
...
var ca = class {
    ...
    m() {
        const t = this.g;
        if (this.h = Qo(t.createProgram(), "Failed to create WebGL program"), this.Z = ea(this, "\n  attribute vec2 aVertex;\n  attribute vec2 aTex;\n  varying vec2 vTex;\n  void main(void) {\n    gl_Position = vec4(aVertex, 0.0, 1.0);\n    vTex = aTex;\n  }", t.VERTEX_SHADER), this.Y = ea(this, this.G(), t.FRAGMENT_SHADER), t.linkProgram(this.h), !t.getProgramParameter(this.h, t.LINK_STATUS)) throw Error(`Error during program linking: ${t.getProgramInfoLog(this.h)}`);
...
function Ka(t, e, n, r) {
    if (t.U) {
        ...
        if (n?.rotationDegrees) {
            ...
            if (An(s, 5, -Math.PI * n.rotationDegrees / 180), n?.rotationDegrees % 180 != 0) {
                const [t, r] = Bo(e);
...
var Za = class extends Ja {
    ...
    o(t) {
        return "minDetectionConfidence" in t && An(this.h, 2, t.minDetectionConfidence ?? .5), "minSuppressionThreshold" in t && An(this.h, 3, t.minSuppressionThreshold ?? .3), this.l(t);
    }
    D(t, e) {
        return this.j = {
            detections: []
...
var uc = class extends Ja {
    ...
    m() {
        ...
        Xi(n, "mediapipe.tasks.vision.face_landmarker.FaceLandmarkerGraph"), Hi(n, "IMAGE:image_in"), Hi(n, "NORM_RECT:norm_rect"), Wi(n, "NORM_LANDMARKS:face_landmarks"), n.o(e), qi(t, n), this.g.attachProtoVectorListener("face_landmarks", (t, e)=>{
            ...
            if (this.outputFaceBlendshapes) for (const e of t)t = ss(e), this.j.faceBlendshapes.push(So(t.g() ?? []));
            Yo(this, e);
...
var lc = class extends Ja {
    ...
    Ka(t, e, n) {
        ...
        if (this.h = "function" == typeof e ? e : n, Ya(this, t, r ?? {}), !this.h) return this.s;
    }
    m() {
        var t = new Qi;
...
function gc(t, e = !0) {
    ...
    for (const i of t){
        var r = ss(i);
        t = [];
        for (const n of r.g())r = e && null != _n(n, 1) ? _n(n, 1) ?? 0 : -1, t.push({
            score: En(n, 2) ?? 0,
            index: r,
            categoryName: vn(n, 3) ?? "" ?? "",
            displayName: vn(n, 4) ?? "" ?? ""
...
var mc = class extends Ja {
    ...
    o(t) {
        if (Tn(this.v, 3, t.numHands ?? 1), "minHandDetectionConfidence" in t && An(this.v, 2, t.minHandDetectionConfidence ?? .5), "minTrackingConfidence" in t && An(this.s, 4, t.minTrackingConfidence ?? .5), "minHandPresenceConfidence" in t && An(this.C, 2, t.minHandPresenceConfidence ?? .5), t.cannedGesturesClassifierOptions) {
            var e = new Ws, n = e, r = ko(t.cannedGesturesClassifierOptions, hn(this.h, Ws, 3)?.h());
            dn(n, 0, 2, r), dn(this.h, 0, 3, e);
        } else void 0 === t.cannedGesturesClassifierOptions && hn(this.h, Ws, 3)?.g();
        return t.customGesturesClassifierOptions ? (dn(n = e = new Ws, 0, 2, r = ko(t.customGesturesClassifierOptions, hn(this.h, Ws, 4)?.h())), dn(this.h, 0, 4, e)) : void 0 === t.customGesturesClassifierOptions && hn(this.h, Ws, 4)?.g(), this.l(t);
    }
    Fa(t, e) {
...
var _c = class extends Ja {
    ...
    o(t) {
        return "numHands" in t && Tn(this.j, 3, t.numHands ?? 1), "minHandDetectionConfidence" in t && An(this.j, 2, t.minHandDetectionConfidence ?? .5), "minTrackingConfidence" in t && An(this.h, 4, t.minTrackingConfidence ?? .5), "minHandPresenceConfidence" in t && An(this.s, 2, t.minHandPresenceConfidence ?? .5), this.l(t);
    }
    D(t, e) {
...
var Ac = class extends Ja {
    ...
    o(t) {
        return "minFaceDetectionConfidence" in t && An(this.s, 2, t.minFaceDetectionConfidence ?? .5), "minFaceSuppressionThreshold" in t && An(this.s, 3, t.minFaceSuppressionThreshold ?? .3), "minFacePresenceConfidence" in t && An(this.H, 2, t.minFacePresenceConfidence ?? .5), "outputFaceBlendshapes" in t && (this.outputFaceBlendshapes = !!t.outputFaceBlendshapes), "minPoseDetectionConfidence" in t && An(this.v, 2, t.minPoseDetectionConfidence ?? .5), "minPoseSuppressionThreshold" in t && An(this.v, 3, t.minPoseSuppressionThreshold ?? .3), "minPosePresenceConfidence" in t && An(this.L, 2, t.minPosePresenceConfidence ?? .5), "outputPoseSegmentationMasks" in t && (this.outputPoseSegmentationMasks = !!t.outputPoseSegmentationMasks), "minHandLandmarksConfidence" in t && An(this.K, 2, t.minHandLandmarksConfidence ?? .5), this.l(t);
    }
    D(t, e, n) {
        const r = "function" != typeof e ? e : {};
    ...
    m() {
        ...
        Xi(r, "mediapipe.tasks.vision.holistic_landmarker.HolisticLandmarkerGraph"), yn(r, 8, xi, n), Hi(r, "IMAGE:input_frames_image"), Wi(r, "POSE_LANDMARKS:pose_landmarks"), Wi(r, "POSE_WORLD_LANDMARKS:pose_world_landmarks"), Wi(r, "FACE_LANDMARKS:face_landmarks"), Wi(r, "LEFT_HAND_LANDMARKS:left_hand_landmarks"), Wi(r, "LEFT_HAND_WORLD_LANDMARKS:left_hand_world_landmarks"), Wi(r, "RIGHT_HAND_LANDMARKS:right_hand_landmarks"), Wi(r, "RIGHT_HAND_WORLD_LANDMARKS:right_hand_world_landmarks"), r.o(e), qi(t, r), $o(this, t), this.g.attachProtoListener("pose_landmarks", (t, e)=>{
            ...
            this.outputFaceBlendshapes && (t = ss(t), n.push(So(t.g() ?? []))), Yo(this, e);
...
var bc = class extends Ja {
    ...
    m() {
        ...
        Xi(n, "mediapipe.tasks.vision.image_classifier.ImageClassifierGraph"), Hi(n, "IMAGE:input_image"), Hi(n, "NORM_RECT:norm_rect"), Wi(n, "CLASSIFICATIONS:classifications"), n.o(e), qi(t, n), this.g.attachProtoListener("classifications", (t, e)=>{
            this.j = function(t) {
                const e = {
                    classifications: ln(t, ys, 1).map((t)=>So(hn(t, rs, 4)?.g() ?? [], _n(t, 2) ?? 0, vn(t, 3) ?? ""))
                };
                return null != he(Ve(t, 2)) && (e.timestampMs = he(Ve(t, 2)) ?? 0), e;
            }(_s(t)), Yo(this, e);
...
var Rc = class extends Ja {
    ...
    o(t) {
        return void 0 !== t.displayNamesLocale ? He(this.h, 2, de(t.displayNamesLocale)) : "displayNamesLocale" in t && He(this.h, 2), "outputCategoryMask" in t && (this.outputCategoryMask = t.outputCategoryMask ?? !1), "outputConfidenceMasks" in t && (this.outputConfidenceMasks = t.outputConfidenceMasks ?? !0), super.l(t);
    }
    J() {
        !function(t) {
            const e = ln(t.ca(), zi, 1).filter((t)=>(vn(t, 1) ?? "").includes("mediapipe.tasks.TensorsToSegmentationCalculator"));
            if (t.s = [], e.length > 1) throw Error("The graph has more than one mediapipe.tasks.TensorsToSegmentationCalculator.");
            1 === e.length && (hn(e[0], Gi, 7)?.l()?.g() ?? new Map).forEach((e, n)=>{
                t.s[Number(n)] = vn(e, 1) ?? "";
            });
        }(this);
    }
...
var Kc = class extends Ja {
    ...
    o(t) {
        return "numPoses" in t && Tn(this.j, 4, t.numPoses ?? 1), "minPoseDetectionConfidence" in t && An(this.j, 2, t.minPoseDetectionConfidence ?? .5), "minTrackingConfidence" in t && An(this.h, 4, t.minTrackingConfidence ?? .5), "minPosePresenceConfidence" in t && An(this.v, 2, t.minPosePresenceConfidence ?? .5), "outputSegmentationMasks" in t && (this.outputSegmentationMasks = t.outputSegmentationMasks ?? !1), this.l(t);
    }
    D(t, e, n) {
        const r = "function" != typeof e ? e : {};
...
//# sourceMappingURL=9e883_6f490f0a._.js.map